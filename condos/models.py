...
class Condos(models.Model):
    ...
    building_type = models.IntegerField(default=None)
    condo_type = models.ForeignKey(CondoType, on_delete=models.CASCADE)
    condo_corp = models.CharField(max_length=64, blank=True)
    floors = models.IntegerField()
    units = models.IntegerField()
    builder = models.IntegerField(default=None)
    architect = models.IntegerField(default=None)
    interior_designer = models.IntegerField(default=None)
    date_completed = models.DateTimeField(default=None)
    pm = models.IntegerField(default=None)
