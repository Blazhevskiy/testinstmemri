    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.BooleanField(default=False, help_text='Subscription', verbose_name='Subscription')),
                ('language_id', models.CharField(choices=[('en', 'english'), ('ru', 'russian')], help_text='Language', max_length=2)),
